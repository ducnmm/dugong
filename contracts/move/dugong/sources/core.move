...
public(package) fun account_processed_tweets_mut(
    account: &mut DugongAccount,
): &mut Table<String, bool> {
...
public(package) fun new_account(xid: String, handle: String, ctx: &mut TxContext): DugongAccount {
    DugongAccount {
        id: object::new(ctx),
        xid,
        handle,
