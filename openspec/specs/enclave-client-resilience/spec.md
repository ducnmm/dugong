...
Make API/worker calls to the Nautilus enclave resilient, so transient enclave unavailability (cold boot, restart, redeploy) does not hard-fail user actions.
