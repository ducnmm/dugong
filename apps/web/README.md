...
- DugongAccount on-chain interaction
...
1. Clone the repository and navigate to apps/web:
```bash
cd apps/web
```
...
```env
VITE_API_BASE_URL=http://localhost:43001
VITE_ENCLAVE_URL=http://localhost:43000
...
```env
VITE_DUGONG_ACCOUNT_ADDRESS=0x...
VITE_DUGONG_TRANSFER_ADDRESS=0x...
VITE_DUGONG_ENCLAVE_ADDRESS=0x...
```
...
This is part of the Dugong project. Please refer to the main project README for contribution guidelines.
